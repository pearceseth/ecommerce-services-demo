...
1. The systems are split into microservices but share a common database for convenience. Depending on scale and ***budget*** a real system ***might*** want to have a DB per application for the sake of scaling and further data segregation. However, this is often a premature optimization. 
